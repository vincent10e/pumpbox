...
RSpec.describe "collect_courses/new", type: :view do
  before(:each) do
    assign(:collect_course, CollectCourse.new(
      :teacher_id => 1,
      :title => "MyString",
      :overview => "MyText",
  ...
  it "renders new collect_course form" do
    render

    assert_select "form[action=?][method=?]", collect_courses_path, "post" do
